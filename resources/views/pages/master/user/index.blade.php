...
<!-- DataTables -->
<link rel="stylesheet" href="{{ asset(env('APP_PUBLIC') . 'themes/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css') }}">
<link rel="stylesheet" href="{{ asset(env('APP_PUBLIC') . 'themes/plugins/datatables-responsive/css/responsive.bootstrap4.min.css') }}">
<link rel="stylesheet" href="{{ asset(env('APP_PUBLIC') . 'themes/plugins/datatables-buttons/css/buttons.bootstrap4.min.css') }}">
<!-- Select2 -->
<link rel="stylesheet" href="{{ asset(env('APP_PUBLIC') . 'themes/plugins/select2/css/select2.min.css') }}">
<link rel="stylesheet" href="{{ asset(env('APP_PUBLIC') . 'themes/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css') }}">
...
<!-- DataTables  & Plugins -->
<script src="{{ asset(env('APP_PUBLIC') . 'themes/plugins/datatables/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset(env('APP_PUBLIC') . 'themes/plugins/datatables-bs4/js/dataTables.bootstrap4.min.js') }}"></script>
<script src="{{ asset(env('APP_PUBLIC') . 'themes/plugins/datatables-responsive/js/dataTables.responsive.min.js') }}"></script>
<script src="{{ asset(env('APP_PUBLIC') . 'themes/plugins/datatables-responsive/js/responsive.bootstrap4.min.js') }}"></script>
<script src="{{ asset(env('APP_PUBLIC') . 'themes/plugins/datatables-buttons/js/dataTables.buttons.min.js') }}"></script>
<!-- Select2 -->
<script src="{{ asset(env('APP_PUBLIC') . 'themes/plugins/select2/js/select2.full.min.js') }}"></script>
